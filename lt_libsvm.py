"""
LegendreTron on LIBSVM datasets
"""
import argparse
import os
import time
...
# parsing arguments
parser = argparse.ArgumentParser("LegendreTron demo on LIBSVM datasets")

parser.add_argument("--seed", type=int, default=0)
parser.add_argument("--dataset", type=str, default="segment", choices=_libsvms)
...
X, Y = lib.data.load_libsvm(data_path, dataset)

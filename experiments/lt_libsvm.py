"""
run LegendreTron on LIBSVM datasets
"""
import argparse
import os
import time
...
def get_args():
    # parsing arguments
    parser = argparse.ArgumentParser("LegendreTron on LIBSVM datasets")
...
def run(args):
    ...
    link_model = lib.models.LegendreLink(
        n_blocks=args.blocks, K=K, dim_hidden=args.dimh, depth=args.depth
    )
